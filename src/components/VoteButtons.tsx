...
type VoteDocument = Models.Document & { voteStatus?: "upvoted" | "downvoted" };
...
const VoteButtons = ({
    ...
    React.useEffect(() => {
        (async () => {
            if (user) {
                ...
                setVotedDocument(() => (response.documents[0] as VoteDocument) || null);
            }
        })();
    }, [user, id, type]);
    ...
    const toggleUpvote = async () => {
        ...
        try {
            ...
            setVotedDocument(() => data.data.document as VoteDocument);
        } catch (error: any) {
